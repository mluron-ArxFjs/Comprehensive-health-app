...
export declare function getSegmentThumbShapeHorizontal(shapes: SegmentThumbShapes): any;
export declare function getSegmentThumbShapeVertical(shapes: SegmentThumbShapes): any;
/**
