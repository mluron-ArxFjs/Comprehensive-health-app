import { Animation, Browser, ChildProperty, Collection, Complex, Component, Event, EventHandler, Internationalization, NotifyPropertyChanges, Property, SanitizeHtmlHelper, compile, createElement, isNullOrUndefined, merge, print, remove } from '@syncfusion/ej2-base';
                ...
                if (this.pointerDrag && this.activePointer) {
                    if (!isNullOrUndefined(this.activePointer.pathElement)) {
                        ...
                        if (this.axes[axisIndex].pointers[pointerIndex].enableDrag) {
                            ...
                            dragArgs.currentValue = this.axes[axisIndex].pointers[pointerIndex].value =
