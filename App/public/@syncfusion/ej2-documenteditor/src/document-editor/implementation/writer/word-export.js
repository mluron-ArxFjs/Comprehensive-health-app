...
var WordExport = /** @class */ (function () {
    ...
    WordExport.prototype.getBase64ImageString = function (image) {
        var base64ImageString = this.mImages.get(parseInt(image[imageStringProperty[this.keywordIndex]]));
